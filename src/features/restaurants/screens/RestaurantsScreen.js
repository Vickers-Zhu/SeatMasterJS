...
export const RestaurantsScreen = ({ navigation }) => {
  ...
  const restaurants = [
    ...
    },
    {
      ...
      icon: 'https://maps.gstatic.com/mapfiles/place_api/icons/v1/png_71/lodging-71.png',
      photos: [
        'https://images.unsplash.com/photo-1528715471579-d1dbcbf4d3f2?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8YmFja2VyeSUyMGZvb2R8ZW58MHx8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
      ],
